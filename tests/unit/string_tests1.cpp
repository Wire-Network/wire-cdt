...
SYSIO_TEST_BEGIN(string_test_ctr_lit)
...
//// string()
SYSIO_TEST_BEGIN(string_test_ctr_def)
   const string eostr{};
...
SYSIO_TEST_BEGIN(string_test_ctr_char_ptr)
   const char* str0{""};
   const char* str1{"abc"};
...
SYSIO_TEST_BEGIN(string_test_ctr_char_rep)
...
SYSIO_TEST_BEGIN(string_test_ctr_str_sub)
...
SYSIO_TEST_BEGIN(string_test_ctr_cpy)
   const string eostr0{""};
...
SYSIO_TEST_BEGIN(string_test_op_pl)
...
//// const string(const string&& str)
SYSIO_TEST_BEGIN(string_test_ctr_mv)
   const string eostr0{""};
   const string eostr1{"a"};
   const string eostr2{"abcdef"};
...
SYSIO_TEST_BEGIN(string_test_op_pl_ctr_mv)
   string eostr0{""};
   eostr0 += "a";
   string eostr1{"abc"};
   eostr1 += "def";
...
SYSIO_TEST_BEGIN(string_test_op_asgn_1)
   const string eostr0{""};
   const string eostr1{"a"};
   const string eostr2{"abcdef"};
...
SYSIO_TEST_BEGIN(string_test_op_pl_asgn)
   string eostr0{""};
   eostr0 += "a";
   string eostr1{"abc"};
   eostr1 += "def";
...
SYSIO_TEST_BEGIN(string_test_mv_asgn)
   string eostr0{""};
   string eostr1{"a"};
...
SYSIO_TEST_BEGIN(string_test_op_pl_mv)
   string eostr0{""};
   eostr0 += "a";
   string eostr1{"abc"};
   eostr1 += "def";
...
SYSIO_TEST_BEGIN(string_test_op_asgn_2)
   string eostr{};
   eostr = "abcdef";
...
SYSIO_TEST_BEGIN(string_test_op_asgn_pl)
   string eostr{};
   eostr = "";
   eostr += "abcdef";
...
SYSIO_TEST_BEGIN(string_test_char_eq)
   string eostr{"abcdef"};
   CHECK_EQUAL( eostr[0], 'a' )
   CHECK_EQUAL( eostr[5], 'f' )
SYSIO_TEST_END

SYSIO_TEST_BEGIN(string_test_char_eq_pl)
   string eostr{"abc"};
   eostr += "def";
   CHECK_EQUAL( eostr[0], 'a' )
   CHECK_EQUAL( eostr[5], 'f' )
...
SYSIO_TEST_BEGIN(string_test_char_eq_ctr)
   const string eostr{"abcdef"};
   CHECK_EQUAL( eostr[0], 'a' )
   CHECK_EQUAL( eostr[5], 'f' )
SYSIO_TEST_END
...
SYSIO_TEST_BEGIN(string_test_char_eq_at_1)
   string eostr{"abcdef"};
   CHECK_EQUAL( eostr.at(0), 'a' )
   CHECK_EQUAL( eostr.at(5), 'f' )

   CHECK_ASSERT( "sysio::string::at", [&]() {eostr.at(6);} )
SYSIO_TEST_END

//// const char& at(const size_t n) const
SYSIO_TEST_BEGIN(string_test_char_eq_at_2)
   const string eostr{"abcdef"};
   CHECK_EQUAL( eostr.at(0), 'a' )
   CHECK_EQUAL( eostr.at(5), 'f' )

   CHECK_ASSERT( "sysio::string::at const", [&]() {eostr.at(6);} )
SYSIO_TEST_END

SYSIO_TEST_BEGIN(string_test_char_eq_at_3)
   string eostr{""};
   eostr += "abcdef";
...
//// char& front()
SYSIO_TEST_BEGIN(string_test_front_1)
   const string eostr{"abcdef"};
...
SYSIO_TEST_BEGIN(string_test_front_2)
   const string eostr{"abcdef"};
   CHECK_EQUAL( eostr.front(), 'a' )
SYSIO_TEST_END

//// char& back()
SYSIO_TEST_BEGIN(string_test_back_1)
   const string eostr{"abcdef"};
   CHECK_EQUAL( eostr.back(), 'f' )
SYSIO_TEST_END

//// const char& back() const
SYSIO_TEST_BEGIN(string_test_back_2)
   const string eostr{"abcdef"};
   CHECK_EQUAL( eostr.back(), 'f' )
SYSIO_TEST_END

//// char* data()
SYSIO_TEST_BEGIN(string_test_data_1)
   string eostr{"abcdef"};
...
SYSIO_TEST_BEGIN(string_test_data_2)
   const string eostr{"abcdef"};
   CHECK_EQUAL( strcmp(eostr.data(), "abcdef"), 0 )
SYSIO_TEST_END

//// const char* c_str() const
SYSIO_TEST_BEGIN(string_test_null_term_1)
   const string eostr{"abcdef"};
   CHECK_EQUAL( strcmp(eostr.c_str(), "abcdef"), 0 )
   CHECK_EQUAL( eostr.c_str()[eostr.size()], '\0' )
SYSIO_TEST_END

SYSIO_TEST_BEGIN(string_test_null_term_2)
   string eostr{""};
   eostr += "abcdef";
   CHECK_EQUAL( strcmp(eostr.c_str(), "abcdef"), 0 )
   CHECK_EQUAL( eostr.c_str()[eostr.size()], '\0' )
...
//// char* begin()
SYSIO_TEST_BEGIN(string_test_iter_begin_1)
   string eostr{"abcdef"};
...
SYSIO_TEST_BEGIN(string_test_iter_begin_2)
   string eostr{""};
   eostr += "abcdef";
   char* iter{eostr.begin()};
   CHECK_EQUAL( eostr.size(), 6 )
...
SYSIO_TEST_BEGIN(string_test_iter_cbegin)
   string eostr{"abcdef"};
...
//// char* end()
SYSIO_TEST_BEGIN(string_test_iter_end_1)
   string eostr{"abcdef"};
   char* iter{eostr.end()};
   CHECK_EQUAL( eostr.size(), 6 )
   CHECK_EQUAL( eostr.capacity(), 12 )
...
SYSIO_TEST_BEGIN(string_test_iter_end_2)
   string eostr{""};
   eostr += "abcdef";
   char* iter{eostr.end()};
   CHECK_EQUAL( eostr.size(), 6 )
...
SYSIO_TEST_BEGIN(string_test_iter_cend)
   string eostr{"abcdef"};
...
SYSIO_TEST_BEGIN(string_test_empty)
   string eostr{};
...
SYSIO_TEST_BEGIN(string_test_op_plus_char)
   string eostr{"abcdef"};
   CHECK_EQUAL( eostr.size(), 6 )
   eostr += 'g';
...
SYSIO_TEST_BEGIN(string_test_length)
   string eostr{"abcdef"};
...
SYSIO_TEST_BEGIN(string_test_capacity)
   string eostr{"abc"};
...
SYSIO_TEST_BEGIN(string_test_max_size)
   const string eostr{"abcdef"};
   CHECK_EQUAL( eostr.max_size(), string::npos )
SYSIO_TEST_END

//// void reserve(const size_t n)
SYSIO_TEST_BEGIN(string_test_reserve_1)
   string eostr{"abcdef"};
   CHECK_EQUAL( eostr.capacity(), 6 )
   eostr.reserve(10);
...
SYSIO_TEST_BEGIN(string_test_reserve_2)
   string eostr{""};
   eostr += "abcdef";
   CHECK_EQUAL( eostr.capacity(), 12 )
   eostr.reserve(10);
...
SYSIO_TEST_BEGIN(string_test_shrink_to_fit)
   string eostr0{};
   string eostr1{"a"};
   string eostr2{"abcdef"};
...
//// void string::clear()
SYSIO_TEST_BEGIN(string_test_clear_1)
   string eostr{"abcdef"};
   CHECK_EQUAL( eostr.empty(), false )
   eostr.clear();
   CHECK_EQUAL( eostr.empty(), true )
...
SYSIO_TEST_BEGIN(string_test_clear_2)
   string eostr{""};
   eostr += "abcdef";
   CHECK_EQUAL( eostr.empty(), false )
   eostr.clear();
...
SYSIO_TEST_BEGIN(string_test_resize_1)
   string eostr{"abcdef"};
...
SYSIO_TEST_BEGIN(string_test_resize_2)
   string eostr{""};
   eostr += "abcdef";
...
SYSIO_TEST_BEGIN(string_test_swap)
...
SYSIO_TEST_BEGIN(string_test_push_back)
   string eostr{"abcdef"};
   CHECK_EQUAL( eostr.size(), 6 )
   eostr.push_back('g');
   CHECK_EQUAL( eostr.size(), 7 )
...
//// void pop_back()
SYSIO_TEST_BEGIN(string_test_pop_back_1)
...
SYSIO_TEST_BEGIN(string_test_pop_back_2)
   string eostr{"abc"};
   CHECK_EQUAL( eostr.size(), 3 )
   eostr.pop_back();
   eostr.pop_back();
...
SYSIO_TEST_BEGIN(string_test_substr_1)
...
SYSIO_TEST_BEGIN(string_test_substr_2)
   string eostr{""};
   eostr += "abcdef";
   CHECK_EQUAL( strcmp(eostr.substr(0).c_str(), "abcdef"), 0 )
   CHECK_EQUAL( strcmp(eostr.substr(0,0).c_str(), ""), 0 )
...
SYSIO_TEST_BEGIN(string_test_copy_1)
   const string eostr{"abcdef"};
   char str[7]{};
...
SYSIO_TEST_BEGIN(string_test_copy_2)
   string eostr{""};
   eostr += "abcdef";
   char str[7]{};
...
SYSIO_TEST_BEGIN(string_test_copy_3)
   const string eostr{"abcdef"};
   char str[7]{};
   CHECK_ASSERT( "sysio::string::copy", [&]() {eostr.copy(str, 1, eostr.size()+1);} )
SYSIO_TEST_END

//// string& insert(const size_t pos, const char* str)
SYSIO_TEST_BEGIN(string_test_ins_1)
   string eostr{"iii"};
   const char* str{"ooo"};
   eostr.insert(0, str);
...
SYSIO_TEST_BEGIN(string_test_ins_2)
   string eostr{"iii"};
   const char* str{"ooo"};
   eostr.insert(1, str);
...
SYSIO_TEST_BEGIN(string_test_ins_3)
   string eostr{"iii"};
   const char* str{"ooo"};
   eostr.insert(2, str);
...
SYSIO_TEST_BEGIN(string_test_ins_4)
   string eostr{"iii"};
   const char* str{"ooo"};
   eostr.insert(3, str);
...
SYSIO_TEST_BEGIN(string_test_ins_5)
   string eostr{""};
   eostr += "iii";
   const char* str{"ooo"};
   eostr.insert(0, str);
...
SYSIO_TEST_BEGIN(string_test_ins_6)
   string eostr{""};
   eostr += "iii";
   const char* str{"ooo"};
   eostr.insert(1, str);
...
SYSIO_TEST_BEGIN(string_test_ins_7)
   string eostr{""};
   eostr += "iii";
   const char* str{"ooo"};
   eostr.insert(2, str);
...
SYSIO_TEST_BEGIN(string_test_ins_8)
   string eostr{""};
   eostr += "iii";
   const char* str{"ooo"};
   eostr.insert(3, str);
...
int main(int argc, char* argv[]) {
   ...
   SYSIO_TEST(string_test_ctr_lit)
   SYSIO_TEST(string_test_ctr_def)
   SYSIO_TEST(string_test_ctr_char_ptr)
   SYSIO_TEST(string_test_ctr_char_rep)
   SYSIO_TEST(string_test_ctr_str_sub)
   SYSIO_TEST(string_test_ctr_cpy)
   SYSIO_TEST(string_test_op_pl)
   SYSIO_TEST(string_test_ctr_mv)
   SYSIO_TEST(string_test_op_pl_ctr_mv)
   SYSIO_TEST(string_test_op_asgn_1)
   SYSIO_TEST(string_test_op_pl_asgn)
   SYSIO_TEST(string_test_mv_asgn)
   SYSIO_TEST(string_test_op_pl_mv)
   SYSIO_TEST(string_test_op_asgn_2)
   SYSIO_TEST(string_test_op_asgn_pl)
   SYSIO_TEST(string_test_char_eq)
   SYSIO_TEST(string_test_char_eq_pl)
   SYSIO_TEST(string_test_char_eq_ctr)
   SYSIO_TEST(string_test_char_eq_at_1)
   SYSIO_TEST(string_test_char_eq_at_2)
   SYSIO_TEST(string_test_char_eq_at_3)
   SYSIO_TEST(string_test_front_1)
   SYSIO_TEST(string_test_front_2)
   SYSIO_TEST(string_test_back_1)
   SYSIO_TEST(string_test_back_2)
   SYSIO_TEST(string_test_data_1)
   SYSIO_TEST(string_test_data_2)
   SYSIO_TEST(string_test_null_term_1)
   SYSIO_TEST(string_test_null_term_2)
   SYSIO_TEST(string_test_iter_begin_1)
   SYSIO_TEST(string_test_iter_begin_2)
   SYSIO_TEST(string_test_iter_cbegin)
   SYSIO_TEST(string_test_iter_end_1)
   SYSIO_TEST(string_test_iter_end_2)
   SYSIO_TEST(string_test_iter_cend)
   SYSIO_TEST(string_test_empty)
   SYSIO_TEST(string_test_op_plus_char)
   SYSIO_TEST(string_test_length)
   SYSIO_TEST(string_test_capacity)
   SYSIO_TEST(string_test_max_size)
   SYSIO_TEST(string_test_reserve_1)
   SYSIO_TEST(string_test_reserve_2)
   SYSIO_TEST(string_test_shrink_to_fit)
   SYSIO_TEST(string_test_clear_1)
   SYSIO_TEST(string_test_clear_2)
   SYSIO_TEST(string_test_resize_1)
   SYSIO_TEST(string_test_resize_2)
   SYSIO_TEST(string_test_swap)
   SYSIO_TEST(string_test_push_back)
   SYSIO_TEST(string_test_pop_back_1)
   SYSIO_TEST(string_test_pop_back_2)
   SYSIO_TEST(string_test_substr_1)
   SYSIO_TEST(string_test_substr_2)
   SYSIO_TEST(string_test_copy_1)
   SYSIO_TEST(string_test_copy_2)
   SYSIO_TEST(string_test_copy_3)
   SYSIO_TEST(string_test_ins_1)
   SYSIO_TEST(string_test_ins_2)
   SYSIO_TEST(string_test_ins_3)
   SYSIO_TEST(string_test_ins_4)
   SYSIO_TEST(string_test_ins_5)
   SYSIO_TEST(string_test_ins_6)
   SYSIO_TEST(string_test_ins_7)
   SYSIO_TEST(string_test_ins_8)
